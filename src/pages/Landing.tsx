...
import Link from "next/link" // You can replace this with React Router's Link if not using Next.js
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#hero" className="text-white hover:text-orange-300 transition-colors" onClick={(e) => {
                e.preventDefault();
                document.getElementById('hero')?.scrollIntoView({ behavior: 'smooth' });
              }}>Home</a>
              <a href="#services" className="text-white hover:text-orange-300 transition-colors" onClick={(e) => {
                e.preventDefault();
                document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' });
              }}>Our services</a>
              <a href="#why-choose-us" className="text-white hover:text-orange-300 transition-colors" onClick={(e) => {
                e.preventDefault();
                document.getElementById('why-choose-us')?.scrollIntoView({ behavior: 'smooth' });
              }}>Why choose us</a>
              <a href="#testimonials" className="text-white hover:text-orange-300 transition-colors" onClick={(e) => {
                e.preventDefault();
